<div class="row g-lg-5 py-5 ps-lg-5">
    <div class="col-lg-6 text-center text-lg-start">
        <h1 class="display-3 fw-bold lh-1 mb-3">Willows Village</h1>
        ...
        <h1 class="display-4 fw-bold lh-1 mb-2 mt-4">Vision & Goal</h1>
        <p class="col-lg-11 fs-3">
    ...
    <div class="col-md-10 col-lg-6">
        <h1 class="display-4 fw-bold lh-1 mb-3">Proposed Map</h1>
